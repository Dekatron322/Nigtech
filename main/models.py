...
class Work(models.Model):
	...
	sitename = models.CharField(max_length=160, default="none")
	image = models.ImageField(upload_to='images')
	description = models.TextField()
	tools = models.CharField(max_length=160, default="none")
	webtype = models.CharField(max_length=160, default="none")
